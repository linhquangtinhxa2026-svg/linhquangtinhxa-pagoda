      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mb-14">
          ...
          >
            ...
            <span className="text-[#c4973a] italic">{t("branchPagodas.titleEmphasis")}</span>
          </h2>
          ...
          {BRANCH_PAGODAS.map((pagoda) => (
            <div key={pagoda.slug} className="group">
              <div className="relative aspect-[3/4] w-full overflow-hidden">
                ...
                />
                <h3
                  className="absolute bottom-4 left-4 right-4 text-lg font-semibold text-[#fdf8f0]"
                  style={{ fontFamily: "var(--font-serif)" }}
                >
                  {pagoda.name}
                </h3>
              ...
              <div className="mt-4 space-y-2.5">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm leading-relaxed text-[#2c1810]/60">{pagoda.address}</p>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-[#2c1810]/60 tabular-nums">{pagoda.phone}</p>
                </div>
              </div>
            </div>
          ))}
