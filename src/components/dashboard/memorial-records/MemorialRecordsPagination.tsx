...
interface MemorialRecordsPaginationProps {
  page: number;
  totalPages: number;
  totalItems: number;
  perPage: number;
...
export function MemorialRecordsPagination({
  page,
  totalPages,
  totalItems,
  perPage,
  onPageChange,
  onPerPageChange,
}: MemorialRecordsPaginationProps) {
    ...
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
      <div className="flex items-center gap-4">
        <TypographyMuted className="text-xs font-semibold uppercase tracking-wider !mt-0 whitespace-nowrap">
          <Trans
            i18nKey="memorialRecords.totalItems"
      ...
      <div className="flex items-center gap-1.5">
        <Button
          ...
          aria-label={t("memorialRecords.prev")}
        >
        ...
        <Button
          ...
          onClick={() => onPageChange(page + 1)}
          aria-label={t("memorialRecords.next")}
        >
