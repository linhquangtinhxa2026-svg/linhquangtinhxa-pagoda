...
interface PrayerEventsArchiveBulkActionsBarProps {
  selectedCount: number;
  onRestoreSelected: () => void;
  onDeleteSelectedPermanently: () => void;
}

export function PrayerEventsArchiveBulkActionsBar({
  selectedCount,
  onRestoreSelected,
  onDeleteSelectedPermanently,
}: PrayerEventsArchiveBulkActionsBarProps) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      >
        ...
        {t("prayerEventsArchive.restoreSelected", { count: selectedCount })}
      </Button>
      <Button
        type="button"
      ...
      >
        ...
        {t("prayerEventsArchive.deleteSelectedPermanently", { count: selectedCount })}
      </Button>
    </div>
  );
}
